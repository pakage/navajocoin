...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Aug 25 07:35:44 2014
# Project:  NavajoAnonBeta-qt.pro
# Template: app
# Command: /usr/bin/qmake USE_UPNP=- -o Makefile NavajoAnonBeta-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_WEBKIT -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu /root/Desktop/NavajoAnonBeta-Linux/src/leveldb/libleveldb.a /root/Desktop/NavajoAnonBeta-Linux/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
$(TARGET): /root/Desktop/NavajoAnonBeta-Linux/src/leveldb/libleveldb.a /root/Desktop/NavajoAnonBeta-Linux/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_ChatWindow.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: NavajoAnonBeta-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile NavajoAnonBeta-qt.pro
...
/root/Desktop/NavajoAnonBeta-Linux/src/leveldb/libleveldb.a: FORCE
	cd /root/Desktop/NavajoAnonBeta-Linux/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/root/Desktop/NavajoAnonBeta-Linux/build/build.h: FORCE
	cd /root/Desktop/NavajoAnonBeta-Linux; /bin/sh share/genbuild.sh /root/Desktop/NavajoAnonBeta-Linux/build/build.h
...
build/moc_ChatWindow.cpp: build/ui_ChatWindow.h \
		src/qt/ChatWindow.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/ChatWindow.h -o build/moc_ChatWindow.cpp
