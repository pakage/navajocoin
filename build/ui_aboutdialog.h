...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        AboutDialog->setStyleSheet(QStringLiteral("background-image: url(:/images2/8);"));
        ...
        versionLabel->setText(QStringLiteral("1.0.0 - UT-ZAH-HA-DEZ-BIN "));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About NavajoAnonBeta", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>NavajoAnonBeta</b> version", 0));
