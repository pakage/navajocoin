...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 NAB"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 NAB"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 NAB"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 NAB"));
