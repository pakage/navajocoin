...
static const int LAST_POW_BLOCK = 50000; // at 30 second blocks will be about 14 days from launch
...
static const uint256 hashGenesisBlock("000007f4b1d442ccecca632c6cd1024463f40d984a8dec009dbc5101a704991b");
static const uint256 hashGenesisBlockTestNet("000007f4b1d442ccecca632c6cd1024463f40d984a8dec009dbc5101a704991b");

static const uint256 CheckBlock1 ("000000d87ec79f9ecb5b7e87247aeed1f2c0957b976458b2e61b9e54e8381eb3"); // Checkpoint at block 1
...
public:
    ...
    {
        // navajoanonbeta: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // navajoanonbeta: get transaction coin age
...
public:
    ...
    // navajoanonbeta: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // navajoanonbeta: two types of block: proof-of-work or proof-of-stake
    ...
    // navajoanonbeta: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // navajoanonbeta: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // navajoanonbeta: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // navajoanonbeta: block index flags
    enum  
    {
