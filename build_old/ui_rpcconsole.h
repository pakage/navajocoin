...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "NavajoAnonBeta - Debug window", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the NavajoAnonBeta/NavajoAnonBeta debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the NavajoAnonBeta/NavajoAnonBeta-Qt help message to get a list with possible NavajoAnonBeta/NavajoAnonBeta command-line options.", 0));
#endif // QT_NO_TOOLTIP
